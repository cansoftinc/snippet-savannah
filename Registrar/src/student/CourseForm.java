...
public class CourseForm extends JFrame {
    ...
    private void initComponents() {
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.courseCode}"), courseCodeField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue("null");
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), courseCodeField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(courseCodeField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
        ...
        getAccessibleContext().setAccessibleName("Course");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<student.Course> toRemove = new ArrayList<student.Course>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            student.Course c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        if ("".equals(String.valueOf(courseCodeField.getText()))) {
            JOptionPane.showMessageDialog(this, "Please enter CourseCode", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        } else if ("".equals(String.valueOf(courseNameField.getText()))) {
            JOptionPane.showMessageDialog(this, "Please enter CourseName", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        } else {
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        if ("".equals(String.valueOf(courseCodeField.getText()))) {
            ...
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<student.Course> merged = new ArrayList<student.Course>(list.size());
                for (student.Course c : list) {
    ...
    private java.util.List<student.Course> list;
